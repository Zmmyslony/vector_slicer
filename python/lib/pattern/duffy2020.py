...
def topological_defect(r: float, charge: float, line_width_mm: float, angle_offset=None, is_displayed=False, **kwargs):
    pattern = topological_defect_pattern(r, charge, angle_offset)
    return pattern.generateInputFiles(line_width_mm, is_displayed=is_displayed, **kwargs)
